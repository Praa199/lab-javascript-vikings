...
describe('Saxon', () => {
  ...
  it('should inherit from Soldier', () => {    expect(saxon instanceof Soldier).toEqual(true);  });
...
describe('War', () => {
  ...
  describe('addSaxon() method', () => {  it('should be a function', () => {    expect(typeof war.addSaxon).toBe('function');  });  it('should receive 1 argument (a Saxon object)', () => {    expect(war.addSaxon.length).toEqual(1);  });  it('should add the received Saxon to the army', () => {    war.addSaxon(saxon);    expect(war.saxonArmy).toEqual([saxon]);  });  it("shouldn't return anything", () => {    expect(war.addSaxon(saxon)).toEqual(undefined);  });
  });
